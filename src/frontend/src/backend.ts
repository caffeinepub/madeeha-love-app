...
export class Backend implements backendInterface {
    ...
    async getReply(arg0: Time): Promise<Reply> {
        if (this.processError) {
            try {
                const result = await this.actor.getReply(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitReply(arg0: ReplyPayload): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitReply(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
